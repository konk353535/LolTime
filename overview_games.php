  ...
  <body>
    ...
    <div class="jumbotron" >
      ...
      <form class="navbar-form navbar-right" role="search">
		  ...
		  <button type="button" class="btn btn-default" onmousedown="graph()">Graph</button>
		</form>
	...
	function graph(){
		...
		var url = "get_group_game_number.php?GroupName=" + groupName + "&timeOption=" + timeOption;
	...
	function update_graph(graph_data) {
	    ...
	    for(i = 0; i < arr.length; i++) {
	        ...
	        dataRaw.push(parseInt(arr[i].Games));
	    }
